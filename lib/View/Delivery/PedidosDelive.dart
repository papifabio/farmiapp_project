...
class PedidosDelive extends StatefulWidget {
  const PedidosDelive({super.key});

  @override
  State<PedidosDelive> createState() => _PedidosDeliveState();
}

class _PedidosDeliveState extends State<PedidosDelive> {
  @override
        ...
        builder: (context, snapshot) {
          ...
          return StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('pedidos')
                  .where('estado',
                      isEqualTo: 'Contacto con el servicio de envío')
                  .where('documentD',
